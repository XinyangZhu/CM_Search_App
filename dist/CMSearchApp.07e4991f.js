...
var Button = _styledComponents2.default.button(_templateObject, function (props) {
	return props.primary ? 'palevioletred' : 'transparent';
}, function (props) {
	return props.primary ? 'white' : 'palevioletred';
}, function (props) {
	return props.primary ? '1em' : '1.2em';
});

var switchPageFunc = function switchPageFunc(page) {
	if (GENDER) {
		if (page == 0) {
			$("#search_wrapper").hide();
			$("#occupations_wrapper").show();
			$("#fav_wrapper").hide();
			$("#Home").attr('class', 'nav-link active');
			$("#Search").attr('class', 'nav-link');
			$("#Favorates").attr('class', 'nav-link');
		} else {
			if (page == 1) {
				$("#occupations_wrapper").hide();
				$("#search_wrapper").show();
				$("#fav_wrapper").hide();
				$("#Search").attr('class', 'nav-link active');
				...
				$("#Search").attr('class', 'nav-link');
				$("#Home").attr('class', 'nav-link');
				$("#Favorates").attr('class', 'nav-link active');
			}
		}
	}
};
...
$("#Favorates").click(function (event) {
	switchPageFunc(2);
	_reactDom2.default.render(_react2.default.createElement(Fav, null), document.getElementById("fav_container"));
});
...
var Authorization = function Authorization() {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			'p',
			{ className: 'lead', id: 'auth_text' },
			'Please choose your gender in order to proceed. '
		),
		_react2.default.createElement(
			Button,
...
var authorize = function authorize(gender) {
	...
	var url = gender == 0 ? 'https://mapakarier.org/backend/www/api/v1/auth/login/User/DE2w42N!@/male' : 'https://mapakarier.org/backend/www/api/v1/auth/login/User/DE2w42N!@/fem';

	var request = new Request(url);

	fetch(request, init).then(function (response) {
		response.text().then(function (text) {
			GENDER = JSON.parse(text)["gender"];
			if (GENDER == "male") {
				$("#occupation_title").text($("#occupation_title").text() + " For Male");
				$("#search_title").text($("#search_title").text() + " For Male");
			} else {
				$("#occupation_title").text($("#occupation_title").text() + " For Female");
				$("#search_title").text($("#search_title").text() + " For Female");
			}
		...
		$('#auth_text').text("Some error occurred. Please try again. ");
	});

	return;
};

_reactDom2.default.render(_react2.default.createElement(Authorization, null), document.getElementById('authorize_wrapper'));
...
var SearchArea = function SearchArea() {
	return _react2.default.createElement(
		'div',
		null,
		_react2.default.createElement(Input, { id: 'search_box', placeholder: 'Occupation Name', onChange: showSearchedOccupation }),
		_react2.default.createElement('br', null),
		_react2.default.createElement(
			Button,
			{ primary: true, onClick: showSearchedOccupation },
			'Search'
		)
	);
};

var showSearchedOccupation = function showSearchedOccupation() {
	if ($("#search_box").val()) {
		_reactDom2.default.render(_react2.default.createElement(SearchResult, { target: $("#search_box").val() }), document.getElementById('search_result_container'));
	} else {
		_reactDom2.default.render(_react2.default.createElement('br', null), document.getElementById('search_result_container'));
	}
};
...
var SearchResult = function (_React$Component) {
	...
	function SearchResult(props) {
		...
		_this.state = { occupations: [] };
		_this.occupationSearcher = _this.occupationSearcher.bind(_this);
		_this.listChoices = _this.listChoices.bind(_this);
		_this.singleChoice = _this.singleChoice.bind(_this);
		_this.showChosen = _this.showChosen.bind(_this);
		return _this;
	}

	_createClass(SearchResult, [{
		key: 'occupationSearcher',
		value: function occupationSearcher() {
			var _this2 = this;

			// if (ALL_OCCUPATIONS) {
			// 	console.log(ALL_OCCUPATIONS.length);
			// 	this.setState({occupations: ALL_OCCUPATIONS.filter((occupation) => 
			// 		(occupation.name.includes(this.props.target))
			// 	)});
			// 	console.log(this.state.occupations.length);
			// 	ReactDOM.render(this.listChoices(), document.getElementById("choices_list"));
			// } else {
			// 	var data = {};
			// 	var init = {
			// 		method: 'post',
			...
			// 			ALL_OCCUPATIONS = data;
			// 			this.setState({occupations: data.filter((occupation) => 
			// 				(occupation.name.includes(this.props.target))
			// 			)});
			// 			return this.state.occupations;
			// 		}).then((occupations) => {
			// 			ReactDOM.render(this.listChoices(), document.getElementById("choices_list"));
			// 		}).catch((error) => {
			// 			$('#search_result_container').text("Some error occurred. Please try again. ");
			// 		})
			// 	});
			// }
			var data = {};
			...
			fetch(request, init).then(function (response) {
				response.text().then(function (text) {
					data = JSON.parse(text);
					_this2.setState({ occupations: data.filter(function (occupation) {
							return occupation.name.toLowerCase().includes(_this2.props.target.toLowerCase());
						}) });
					return _this2.state.occupations;
				}).then(function (occupations) {
					_reactDom2.default.render(_this2.listChoices(), document.getElementById("choices_list"));
				}).catch(function (error) {
					$('#choices_list').text("Some error occurred. Please try again. ");
				});
			});
		}
	}, {
		...
		value: function listChoices() {
			...
			if (this.state.occupations.length) {
				return _react2.default.createElement(
					'div',
					{ style: { borderRadius: "3px", border: "2px solid palevioletred", paddingTop: "1em" } },
					_react2.default.createElement(
						'ul',
						null,
						this.state.occupations.map(function (choice) {
							return _this3.singleChoice(choice);
						})
					)
				);
			} else {
				return _react2.default.createElement(
					'p',
					{ style: { color: "palevioletred", fontSize: "1.8em" } },
					'No result! '
				);
			}
		}
		...
		key: 'singleChoice',
		value: function singleChoice(choice) {
			var _this4 = this;

			return _react2.default.createElement(
				'li',
				{ key: choice.id, style: { fontSize: "1.8em" }, onClick: function onClick() {
						return _this4.showChosen(choice);
					} },
				choice.name
			);
		}
		...
		key: 'showChosen',
		value: function showChosen(choice) {
			var data = {};
			var init = {
				method: 'post',
				mode: 'cors',
			...
			var url = 'https://mapakarier.org/backend/www/api/v1/occupation/getJobStatistics/' + choice.id;
			var request = new Request(url);

			fetch(request, init).then(function (response) {
				response.text().then(function (text) {
					data = JSON.parse(text);
					_reactDom2.default.render(_react2.default.createElement(OccupationDetail, { basic: choice, detail: data }), document.getElementById("search_result_container"));
				}).catch(function (error) {
					$('#search_result_container').text("Some error occurred. Please try again. ");
				});
			});
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'p',
					null,
					'Please choose the occupation that you want to search for. '
				),
				_react2.default.createElement(
					'div',
					{ id: 'choices_list' },
...
var OccupationDetail = function (_React$Component2) {
	_inherits(OccupationDetail, _React$Component2);

	function OccupationDetail(props) {
		_classCallCheck(this, OccupationDetail);

		var _this5 = _possibleConstructorReturn(this, (OccupationDetail.__proto__ || Object.getPrototypeOf(OccupationDetail)).call(this, props));

		_this5.state = { faved: false };
		_this5.favButtonRegion = _this5.favButtonRegion.bind(_this5);
		_this5.favButtonMaker = _this5.favButtonMaker.bind(_this5);
		return _this5;
	}

	_createClass(OccupationDetail, [{
		key: 'favButtonRegion',
		value: function favButtonRegion() {
			if (this.state.faved) {
				return _react2.default.createElement(
					Button,
					{ onClick: this.favButtonMaker },
					'Remove from favorates'
				);
			} else {
				return _react2.default.createElement(
					Button,
					{ primary: true, onClick: this.favButtonMaker },
					'Add to favorates'
				);
			}
		}
		...
		key: 'favButtonMaker',
		value: function favButtonMaker() {
			if (this.state.faved) {
				for (var i = 0; i < FAV.length; i++) {
					if (FAV[i].id == this.props.basic.id) {
						FAV.splice(i, 1);
					}
				}
				this.setState({ faved: false });
			} else {
				var newFav = { id: this.props.basic.id, occupation: { name: this.props.basic.name, avatar: this.props.basic.avatar } };
				FAV.push(newFav);
		...
		value: function componentDidMount() {
			...
			var isFaved = FAV.some(function (ele) {
				return ele.id == _this6.props.basic.id;
			});
			this.setState({ faved: isFaved });
			_reactDom2.default.render(this.favButtonRegion(), document.getElementById("fav_button_wrapper"));
		}
	}, {
		key: 'componentDidUpdate',
		value: function componentDidUpdate(prevState) {
			if (this.state.faved != prevState.faved) {
				_reactDom2.default.render(this.favButtonRegion(), document.getElementById("fav_button_wrapper"));
			}
		}
	}, {
		key: 'render',
		value: function render() {
			var OccupationName = _styledComponents2.default.h3(_templateObject3);
			var OccupationDetailWrapper = _styledComponents2.default.section(_templateObject4);
			var Grid = _styledComponents2.default.div(_templateObject5);
			var Detail = _styledComponents2.default.div(_templateObject6, function (props) {
				return props.row;
			});
			var Title = _styledComponents2.default.h5(_templateObject7, function (props) {
				return props.color;
			});
			var Value = _styledComponents2.default.h6(_templateObject8);
			var Bar = _styledComponents2.default.div(_templateObject9);
			var Count = _styledComponents2.default.div(_templateObject10, function (props) {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('img', { src: "https://mapakarier.org/app/assets/" + basic.photo,
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								Bar,
								null,
								_react2.default.createElement(Count, { count: parseInt(detail.salary.count), color: '#FF6859' })
							)
						),
						_react2.default.createElement(
							Detail,
							...
							_react2.default.createElement(
								Bar,
								null,
								_react2.default.createElement(Count, { count: parseInt(detail.market.count), color: '#FFCF44' })
							)
						),
						_react2.default.createElement(
							Detail,
							...
							_react2.default.createElement(
								Bar,
								null,
								_react2.default.createElement(Count, { count: parseInt(detail.demand.count), color: '#B15DFF' })
							)
						),
						_react2.default.createElement(
							Detail,
							...
							_react2.default.createElement(
								Bar,
								null,
								_react2.default.createElement(Count, { count: parseInt(detail.duration.count), color: '#72DEFF' })
							)
						)
					),
					_react2.default.createElement('div', { id: 'fav_button_wrapper' })
				),
				_react2.default.createElement('br', null)
			);
		}
...
_reactDom2.default.render(_react2.default.createElement(SearchArea, null), document.getElementById("search_area"));

var GetAllButton = function GetAllButton() {
	return _react2.default.createElement(
		Button,
		{ onClick: showOccupationsList },
		'Show'
	);
};

var showOccupationsList = function showOccupationsList() {
	if (!document.getElementById('OL')) {
		_reactDom2.default.render(_react2.default.createElement(OccupationsList, null), document.getElementById('occupations_container'));
	}
};

var OccupationsList = function (_React$Component3) {
	_inherits(OccupationsList, _React$Component3);

	function OccupationsList(props) {
		_classCallCheck(this, OccupationsList);

		var _this7 = _possibleConstructorReturn(this, (OccupationsList.__proto__ || Object.getPrototypeOf(OccupationsList)).call(this, props));

		_this7.state = { gender: "", occupations: [] };
		_this7.genderHandler = _this7.genderHandler.bind(_this7);
		_this7.listVisualizer = _this7.listVisualizer.bind(_this7);
		return _this7;
	}

	_createClass(OccupationsList, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
		...
		key: 'componentDidUpdate',
		value: function componentDidUpdate(prevState) {
			if (this.state.gender != prevState.gender && prevState.gender != undefined) {
				this.genderHandler();
			}
		}
	}, {
		key: 'genderHandler',
		value: function genderHandler() {
			var _this8 = this;

			$('#occupations_list').text("Loading...");
			var data = {};
			var init = {
				method: 'post',
				mode: 'cors',
			...
			fetch(request, init).then(function (response) {
				response.text().then(function (text) {
					data = JSON.parse(text);
					_this8.setState({ occupations: data });
					return data;
				}).then(function (data) {
					_reactDom2.default.render(_this8.listVisualizer(), document.getElementById('occupations_list'));
				}).catch(function (error) {
					$('#occupations_list').text("Some error occurred. Please try again. ");
				});
			});
			return;
		}
		...
		key: 'listVisualizer',
		value: function listVisualizer() {
			return _react2.default.createElement(
				'div',
				null,
				this.state.occupations.map(function (occupation) {
					return _react2.default.createElement(Occupation, { key: occupation.id, info: occupation });
				})
			);
		}
	}, {
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('br', null),
				_react2.default.createElement('div', { id: 'occupations_list' })
			);
		}
	}]);
...
var Occupation = function (_React$Component4) {
	_inherits(Occupation, _React$Component4);

	function Occupation() {
		_classCallCheck(this, Occupation);

		return _possibleConstructorReturn(this, (Occupation.__proto__ || Object.getPrototypeOf(Occupation)).apply(this, arguments));
	}

	_createClass(Occupation, [{
		key: 'render',
		value: function render() {
			var OccupationName = _styledComponents2.default.h3(_templateObject11);
			var OccupationWrapper = _styledComponents2.default.section(_templateObject12);
			var Grid = _styledComponents2.default.div(_templateObject13);
			var Avatar = _styledComponents2.default.div(_templateObject14);
			var Photo = _styledComponents2.default.div(_templateObject15);
			var Text = _styledComponents2.default.div(_templateObject16);
			var info = this.props.info;
			var future_job = info.future_job ? "Yes" : "No";
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							Avatar,
							null,
							_react2.default.createElement('img', { src: "https://mapakarier.org/app/assets/" + info.avatar,
								style: { maxHeight: "100%", maxWidth: "100%" } })
						),
						_react2.default.createElement(
							Photo,
							null,
							_react2.default.createElement('img', { src: "https://mapakarier.org/app/assets/" + info.photo,
								style: { maxHeight: "100%", maxWidth: "100%" } })
						),
						_react2.default.createElement(
							Text,
...
_reactDom2.default.render(_react2.default.createElement(GetAllButton, null), document.getElementById('get_all_button'));

var Fav = function (_React$Component5) {
	_inherits(Fav, _React$Component5);

	function Fav(props) {
		_classCallCheck(this, Fav);

		var _this10 = _possibleConstructorReturn(this, (Fav.__proto__ || Object.getPrototypeOf(Fav)).call(this, props));

		_this10.showFavs = _this10.showFavs.bind(_this10);
		return _this10;
	}

	_createClass(Fav, [{
		key: 'showFavs',
		value: function showFavs() {
			return _react2.default.createElement(
				'div',
				null,
				FAV.map(function (fav) {
					return _react2.default.createElement(
						'p',
						{ key: fav.id, style: { fontSize: "1.8em" } },
						fav.occupation.name
					);
				})
			);
		...
		value: function componentDidMount() {
			if (FAV.length > 0) {
				_reactDom2.default.render(this.showFavs(), document.getElementById("fav_inner"));
			} else {
				_reactDom2.default.render(_react2.default.createElement(
					'p',
					{ className: 'lead', style: { color: "palevioletred" } },
					'No occupation has been added here. '
				), document.getElementById("fav_container"));
			}
		}
	}, {
		key: 'componentDidUpdate',
		...
		value: function render() {
			...
			return _react2.default.createElement('div', { id: 'fav_inner', style: { border: "2px solid palevioletred", padding: "1em" } });
		}
	}]);

	return Fav;
}(_react2.default.Component);
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","styled-components":"node_modules/styled-components/dist/styled-components.browser.es.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/CMSearchApp.07e4991f.map