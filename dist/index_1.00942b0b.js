...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"index_1.js":[function(require,module,exports) {
'use strict';
	...
	_createClass(OccupationDetail, [{
		...
		value: function favButtonMaker() {
			if (this.state.faved) {
				...
				// 	}
				// }
				favStore.dispatch({ occupation: { id: this.props.basic.id, name: this.props.basic.name }, type: 'Remove' });
				this.setState({ faved: false });
			} else {
				favStore.dispatch({ occupation: { id: this.props.basic.id, name: this.props.basic.name }, type: 'Add' });
		...
		value: function componentDidMount() {
			...
			var isFaved = favStore.getState().some(function (ele) {
...
// Code for the favorates page. 

var favorates = function favorates() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	var action = arguments[1];

	switch (action.type) {
		case 'Add':
			return [].concat(_toConsumableArray(state), [action.occupation]);
		case 'Remove':
			return state.filter(function (ele) {
				return !(ele.name == action.occupation.name);
			});
		default:
			return state;
	}
...
var favStore = (0, _redux.createStore)(favorates);
...
var Favorates = function Favorates(value) {

	var showFavs = function showFavs(value) {
		console.log(value);
		if (value.length == 0) {
			return _react2.default.createElement(
				'p',
	...
	return _react2.default.createElement(
		'div',
		{ id: 'fav_inner', style: { border: "2px solid palevioletred", padding: "1em" } },
		showFavs(value)
	);
};

var renderFavs = function renderFavs() {
	_reactDom2.default.render(_react2.default.createElement(Favorates, { value: favStore.getState() }), document.getElementById('fav_container'));
};

favStore.subscribe(renderFavs);
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","styled-components":"node_modules/styled-components/dist/styled-components.browser.es.js","redux":"node_modules/redux/es/redux.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index_1.js"], null)
//# sourceMappingURL=/index_1.00942b0b.map